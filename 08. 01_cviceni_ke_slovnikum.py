...
# Task 2
# vytvorit funkci, ktera si od hosta vezme objenavku a vytvori ucet
...
# Task 4
# napiste funkci, ktera vyspise cele menu, - jidla s cenami
def menu(dictionary):
...
datum = sdate1 = dt.strptime(dates[member], "%d.%m.%Y")
rozdil = now - datum
