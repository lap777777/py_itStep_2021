...
"""
#### PRO PRACI SE SOUBORY SI MUSIM VZDY POHLIDAT, ZE SPOUSTIM SOUBOR ZE SLOZKY, KDE JE SOUBOR ULOZENY ###

print("1-Otevirani_souboru-READ--------------------------------------")

file = open(os.path.join(os.curdir, "12_Lekce_zzz", "slova.txt"), encoding="utf-8")   # oteviram si soubor a ukladam ho do promenne
...
file = open("12_Lekce_zzz/slova.txt", encoding="utf-8")
...
# kratsi zapis
for line in open("12_Lekce_zzz/slova.txt", encoding="utf-8"):
    print(line, end="")
file.close()
print()

# nejlepsi zapis:
with open("12_Lekce_zzz/slova.txt", encoding="utf=8") as f:
    for line in f:
        print(line, end="")
...
with open("12_Lekce_zzz/cisla.txt", "w") as f2:    # parametr "w" pro zapisovani
...
with open("12_Lekce_zzz/slova.txt", "a") as f2:    # parametr "a" pro pridani
    for cislo in my_list:
        f2.write("\n" + str(cislo))      

print("6-Zapisovani_ze_stareho_do_noveho_souboru-----------------------")

with open("12_Lekce_zzz/slova.txt") as f1, open("12_Lekce_zzz/nova_slova.txt", "w") as f2:
    for line in f1:
        f2.write(line)
